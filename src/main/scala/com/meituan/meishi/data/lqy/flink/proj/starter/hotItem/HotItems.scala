package com.meituan.meishi.data.lqy.flink.proj.starter.hotItem
...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    val dataStream = env
      .readTextFile("/Users/liqingyong/Works/Learn/Flink/Proj/github/Flink-Examples/src/main/resources/proj/UserBehavior.csv")
      .map(data => {
        val arr = data.split(",")
