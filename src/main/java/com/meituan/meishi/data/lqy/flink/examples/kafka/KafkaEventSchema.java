 ...
 */
public class KafkaEventSchema implements SerializationSchema<KafkaEvent>, DeserializationSchema<KafkaEvent> {

    private static final long serialVersionUID = 6154188370181669758L;

    @Override
    public byte[] serialize(KafkaEvent event) {
//        return GsonHolder.GSON.toJson(event).getBytes();
...
//        return GsonHolder.GSON.fromJson(msg, KafkaEvent.class);
        return KafkaEvent.fromString(msg);
    }
