...
//	private long currentTimestamp = 10000;

	private List<Watermark> watermarks = new CopyOnWriteArrayList<>();
...
//		Watermark watermark = new Watermark(currentTimestamp == 10000 ? 10000 : currentTimestamp - 1);
