...
public class GroupedProcessingTimeWindowExample {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GroupedProcessingTimeWindowExample.class);
...
//                    }
//                })
//                .window(ProcessingTimeSessionWindows.withGap(Time.of(500, MILLISECONDS))
//                .apply(new WindowFunction<Tuple2<Long, Long>, Tuple2<Long, Long>, Long, TimeWindow>() {
//                    @Override
//                    public void apply(Long key, TimeWindow window, Iterable<Tuple2<Long, Long>> values, Collector<Tuple2<Long, Long>> out) throws Exception {
//                        long sum = 0L;
