...
class SeqHolder extends Serializable {
  ...
  //商品销售表数据
  val itemData: Seq[Either[(Long, (Long, Int, String, String)), Long]] = Seq(
  ...
  //页面访问表数据
  val pageAccessData: Seq[Either[(Long, (Long, String, String)), Long]] = Seq(
  ...
  // 页面访问量表数据2
  val pageAccessCountData: Seq[Either[(Long, (Long, String, Int)), Long]] = Seq(
  ...
  // 页面访问表数据3
  val pageAccessSessionData: Seq[Either[(Long, (Long, String, String)), Long]] = Seq(
  ...
  val data: Seq[Either[(Long, Row), Long]] = Seq(
